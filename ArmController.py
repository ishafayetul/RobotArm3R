...
class ArmController(ArmModel):
    def __init__(self, vis):
        ...
        self.link1CurrentAngle = self.link2CurrentAngle = self.link3CurrentAngle = 0
    ...
    def transformations(self, theta1, theta2, theta3):
        """Apply homogeneous transformations and update geometry."""
        self.ht1, self.ht2, self.ht3, self.eep = homogeneousTransformationMatrix(
    ...
    def moveArm(self, targetTheta1, targetTheta2, targetTheta3):
    ...
    def setInitialPos(self, theta1, theta2, theta3):
        ...
        self.publishArmPose()
        self.transformations(self.link1InitialAngle, self.link2InitialAngle, self.link3InitialAngle)

    def moveArmTo(self, x, y, z):
        """Move the arm to the target coordinates using inverse kinematics."""
        targetTheta1, targetTheta2, targetTheta3= inverseKinematics(
            x, y, z, self.link1Length, self.link2Length, self.link3Length
        )
        #print(targetTheta1, targetTheta2, targetTheta3)
        self.moveArm(targetTheta1, targetTheta2, targetTheta3)
